...
public class SecurityConfig {
    ...
    /*
     * WARNING: this is a copy of 'oauth2-authorization-server' project. Therefore, it needs the MySQL container which is composed inside the '06-oauth2-authorization-server' folder.
     * */

    /*
     * http://localhost:1111/oauth2/authorize?response_type=code&client_id=client&scope=openid&redirect_uri=https://springone.io/authorized&code_challenge=fxUGtG8aCl3bUADZ3eQJEp6R-0ilafRflhdE3X29_1U&code_challenge_method=S256
     *
     *
     *http://localhost:1111/oauth2/token
